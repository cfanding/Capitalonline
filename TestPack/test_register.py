...
class Register(unittest.TestCase):
    ...
    def test_register_success(self):
        ...
        self.browser.find_element(By.ID, 'id_mobile').send_keys('17071100098')

        # 输入正确的短信验证码
        self.browser.find_element(By.ID, 'id_checkCode').clear()
        self.browser.find_element(By.ID, 'id_checkCode').send_keys('222777')

        # 输入正确的密码1
        self.browser.find_element(By.ID, 'id_password1').clear()
        self.browser.find_element(By.ID, 'id_password1').send_keys('Test1`')

        # 输入正确的密码2
        self.browser.find_element(By.ID, 'id_password2').clear()
        self.browser.find_element(By.ID, 'id_password2').send_keys('Test1`')
...
if __name__ == '__main__':
    ...
    suite.addTest(Register("test_register_success"))
